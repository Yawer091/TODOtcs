...
const Todo = () => {
  ...
  return (
    <div
      className={`w-[40%] mx-auto mt-[120px] p-[40px] ${
        lrmode === "light" ? "bg-blue-400 text-black" : "bg-gray-900 text-white"
      }`}
    >
      <div className="mb-[20px] flex justify-between">
        <h1 className="text-[34px] font-semibold">TO DO</h1>
        <button onClick={toggleMode}>
          <i
            className={`bx ${
              lrmode === "light" ? "bx-moon" : "bx-sun"
            } text-[42px]`}
          ></i>
        </button>
      </div>
